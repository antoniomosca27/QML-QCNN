...
Esempio d'uso (FAST-MODE):
    qcnn-train --dataset pathmnist \
               --subset 0.05 --subset-val 0.05 --subset-test 0.05 \
               --stride 8 --freeze-q --batch 4 --epochs 1 --device cpu
"""
...
def cli() -> None:
    ...
    parser.add_argument("--stride", type=int, default=2,
                        help="Stride per patchify (2=tutte le patch 2×2, 4=patch sparse, ...)")
