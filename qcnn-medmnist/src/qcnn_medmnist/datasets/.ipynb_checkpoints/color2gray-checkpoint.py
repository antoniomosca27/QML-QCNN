...
in un singolo canale 28×28.  L'inizializzazione di default
ora è *random* così la rete deve apprendere i pesi ottimali.

Se invece vuoi partire dai coefficienti fisici BT.601,
passa esplicitamente init="luma".
"""
...
class Color2GrayNet(nn.Module):
    ...
    init : {"random", "luma"}, default="random"
        - "random": pesi casuali Xavier uniform → la rete apprende da zero.
